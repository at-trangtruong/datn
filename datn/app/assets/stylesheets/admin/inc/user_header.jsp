        ...
        <input type="text" class="form-control" placeholder="Search" name="srch-term" id="srch-term">           
			...
			<nav class="templatemo-left-nav">
				<ul>
					...
					<li><a href="<%=request.getContextPath()%>/admin/user/nha-hang"><i
							class="fa fa-database fa-fw"></i>Nhà hàng</a></li>
					<li><a href="<%=request.getContextPath()%>/admin/user/menu"><i
			...
			<div class="templatemo-top-nav-container">
				<div class="row">
					<nav class="templatemo-top-nav col-lg-12 col-md-12">
						<ul style="margin-left: 200px;" class="text-uppercase">
							<li><a
								href="<%=request.getContextPath()%>/admin/user/sua-tai-khoan?uid=<%=userlogin.getId_user()%>">Tài
									khoản</a></li>
							<li><a href="<%=request.getContextPath()%>/admin/user/user_rest">Tài khoản bàn</a></li>
